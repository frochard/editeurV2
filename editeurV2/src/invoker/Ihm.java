...
public class Ihm extends JFrame implements Observer, ActionListener, KeyListener, CaretListener {
	...
	private SuppressionArriere cmdSuppressionArriereEnregistrableV2;
	private SuppressionAvant cmdSuppressionAvantEnregistrableV2;
	 ...
	 */
	public void setCmdCollerEnregistrable(CollerEnregistrableV2 cmdCollerEnregistrable) {
		this.cmdCollerEnregistrableV2 = cmdCollerEnregistrable;
	}
	 ...
	 */
	public void setCmdCopierEnregistrable(CopierEnregistrableV2 cmdCopierEnregistrable) {
		this.cmdCopierEnregistrableV2 = cmdCopierEnregistrable;
	}
	 ...
	 */
	public void setCmdCouperEnregistrable(CouperEnregistrableV2 cmdCouperEnregistrable) {
		this.cmdCouperEnregistrableV2 = cmdCouperEnregistrable;
	}
	 ...
	 */
	public void setCmdSaisirEnregistrable(SaisirEnregistrableV2 cmdSaisirEnregistrable) {
		this.cmdSaisirEnregistrableV2 = cmdSaisirEnregistrable;
	}
	 ...
	 */
	public void setCmdSelectionnerEnregistrable(SelectionnerEnregistrableV2 cmdSelectionnerEnregistrable) {
		this.cmdSelectionnerEnregistrableV2 = cmdSelectionnerEnregistrable;
	}
	 ...
	 */
	public void setCmdSuppressionArriereEnregistrable(SuppressionArriere cmdSuppressionArriereEnregistrable) {
		this.cmdSuppressionArriereEnregistrableV2 = cmdSuppressionArriereEnregistrable;
	}
	 ...
	 */
	public void setCmdSuppressionAvantEnregistrable(SuppressionAvant cmdSuppressionAvantEnregistrable) {
		this.cmdSuppressionAvantEnregistrableV2 = cmdSuppressionAvantEnregistrable;
	}
	...
	public Ihm(){
		...
		this.setTitle("Moteur d'édition V2");
	...
	public void actionPerformed(ActionEvent event) {
		...
		if((event.getSource() == this.btnCopier) | (event.getSource() == this.mCopier)) {
			...
			if(this.enregistrementActif){
				...
				System.out.println("Appel de la commande copier");
				cmdCopier.execute();
			}
		//fonction couper
			...
			if(this.enregistrementActif){
				...
				System.out.println("Appel de la commande couper");
				cmdCouper.execute();
			}
		//fonction coller
			...
			if(this.enregistrementActif){
				...
				System.out.println("Appel de la commande coller");
				cmdColler.execute();
			}
